...
class TournamentsAmbiguityNumber:
    def scrutinizeTable(self, table):
        ...
        def reduce0(possibility):
            ...
            #### mapping = lambda (a, b, c): (defeated((a, b)) and defeated((b, c)) and defeated((c, a)))
            mapping = (lambda (a, b, c): (valid0((a, b)) and valid0((b, c)) and valid0((c, a))))
        ...
        def valid0(possibility):
            #### return (table[possibility[i]][possibility[j]] == '1')
            return (table[possibility[0]][possibility[1]] == '1')
